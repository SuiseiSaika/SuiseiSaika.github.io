...
- Integrated multi-camera input with detection, segmentation, and oriented bounding box inference.
- Coordinated multi-process dataflow and rule-based grading decisions.
...
- TODO: Add an anonymized architecture diagram, screenshot, or short demo that is safe to publish.
